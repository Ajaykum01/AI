...
USERNAME = environ.get('USERNAME', "https://telegram.me/Shinchan_2807")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001841127465'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/hqmovierequest')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001841127465'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1001841127465'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1001841127465'))
...
SHORTENER_API = environ.get("SHORTENER_API", "4be71cae8f3aeabe56467793a0ee8f20e0906f3a")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'gyanilinks.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "4be71cae8f3aeabe56467793a0ee8f20e0906f3a")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'gyanilinks.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "4be71cae8f3aeabe56467793a0ee8f20e0906f3a")
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002010768345')
